...
* The local Obsidian vault / folder contain all your notes.. but also all the settings (appearance, plugins specific configurations you've set...) meaning that downloading your vault's folder and open it in another computer will yield the **exact** same vault
